...
For `expenses`, `frequency: "annual"` means the configured annual amount is applied as one-twelfth in each active month. Partial first/last years are prorated by active months, mirroring annual income handling.
